...
import { chat_math_question } from "../api/api";

const Math = () => {
  //   const chat_body_question = useMemo(() => chat_Question, []);
  const [chat, setChat] = useState(chat_math_question);
  ...
  return (
    <>
      <div>
        ...
        >
          Chat with your Calculation Skill
        </h3>
